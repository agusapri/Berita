                ...
                <div class="row about-cols">
                    ...
                    <div class="col-md-4 wow fadeInUp">
                        <div class="about-col">
                            ...
                            <!-- <p>
                                <?php echo substr($row->tulisan_isi, 0, 50) . '...'; ?>
                            </p> -->
                        </div>
                    </div>
                    <?php endforeach; ?>
                ...
                <div class="row contact-info">
                    ...
                    <div class="col-md-4">
                        <div class="contact-address">
                            ...
                            <h3>Address</h3>
                            <address>tanjung priok, jakarta utara</address>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="contact-phone">
                            ...
                            <h3>Phone Number</h3>
                            <p><a href="tel:+155895548855">087875384200</a></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="contact-email">
                            ...
                            <h3>Email</h3>
                            <p><a href="mailto:info@example.com">agusaprianto@gmail.com</a></p>
                        </div>
                    </div>
